...
export async function fetchGoogleSubscriptionV2(
    ...
    try {
        ...
        const basePlan = subscription.data.basePlans?.find((x) => x.basePlanId == basePlanId);
        ...
        const obfuscatedExternalAccountId =
            purchase.data.externalAccountIdentifiers?.obfuscatedExternalAccountId ?? undefined;
