...
const decodeSubscriptionReference = (record: SQSRecord): AppleSubscriptionReference => {
...
const defaultStoreSubscriptionInDynamo = (subscription: Subscription): Promise<void> => {
