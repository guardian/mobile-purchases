...
function parseAppleReceiptInfo(payload: unknown): Result<string, AppleReceiptInfo> {
  ...
  if (
    ...
    return err(`incorrect optional field: unique_identifier ${typeof payload.unique_identifier}`);
  }
  if (
  ...
  if (
    ...
    return err(`incorrect optional field: app_account_token ${typeof payload.app_account_token}`);
  }
