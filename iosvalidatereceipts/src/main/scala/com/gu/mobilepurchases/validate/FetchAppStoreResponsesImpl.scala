...
class FetchAppStoreResponsesImpl(appStore: AppStore,
  ...
  private def fetchAppStoreResponses(remainingReceipts: Set[String], processedReceipts: Set[String],
    ...
    val unprocessedReceipts: Set[String] = remainingReceipts.filter((receiptData: String) => !processedReceipts.contains(receiptData))
