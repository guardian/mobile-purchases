...
new FeastGoogleAcquisitionsEvent(app, "FeastAndroidSubscriptions-CODE" , { stack: "mobile-purchases", stage: "CODE", env: { region: "eu-west-1" } });
new FeastGoogleAcquisitionsEvent(app, "FeastAndroidSubscriptions-PROD" , { stack: "mobile-purchases", stage: "PROD", env: { region: "eu-west-1" } });
