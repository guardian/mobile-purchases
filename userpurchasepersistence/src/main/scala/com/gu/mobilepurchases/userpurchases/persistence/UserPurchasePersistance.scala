  ...
  def apply(userPurchasesStringsByUserId: UserPurchasesStringsByUserIdColonAppId): UserPurchasesByUserIdAndAppId = {
    ...
    userIdColonAppIdArray.length match {
      case 2 => UserPurchasesByUserIdAndAppId(
        ...
        userIdColonAppIdArray(1)
        , mapper.readValue[List[UserPurchase]](userPurchasesStringsByUserId.purchases).toSet)
...
trait ScanamaoUserPurchasesStringsByUserIdColonAppId {
  def put(userPurchasesStringsByUserIdColonAppId: UserPurchasesStringsByUserIdColonAppId):
...
object ScanamaoUserPurchasesStringsByUserIdColonAppIdImpl {
  def apply(userPurchaseConfig: UserPurchaseConfig): ScanamaoUserPurchasesStringsByUserIdColonAppIdImpl = new
