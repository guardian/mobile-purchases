...
import com.gu.mobilepurchases.userpurchases.controller.UserPurchasesControllerImpl
...
object UserPurchasesLambda {
  ...
  lazy val userPurchasesController: UserPurchasesControllerImpl = Logging.logOnThrown(() => ssmConfig.identity match {
    case awsIdentity: AwsIdentity => new UserPurchasesControllerImpl(new UserPurchasesImpl(new UserPurchasePersistenceImpl(
