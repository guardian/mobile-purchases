...
lazy val root = project
  ...
  .settings(
    ...
    riffRaffArtifactResources += file("tsc-target/export-subscription-tables-v2.zip") -> s"mobile-purchases-export-subscription-tables-v2/export-subscription-tables-v2.zip",
