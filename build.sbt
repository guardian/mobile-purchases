...
lazy val root = project
  ...
  .settings(
    ...
    riffRaffArtifactResources += file("tsc-target/google-subscription-status.zip.zip") -> s"mobile-purchases-google-subscription-status/google-subscription-status.zip",
