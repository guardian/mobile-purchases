...
lazy val root = project
  ...
  .settings(
    ...
    riffRaffArtifactResources += file(s"${scalaRoot}/subscription-export/scripts/export-CODE.hql") -> s"mobile-subscription-export/export.hql",
    riffRaffArtifactResources += file(s"${scalaRoot}/subscription-export/scripts/export-PROD.hql") -> s"mobile-subscription-export/export.hql"
  )
