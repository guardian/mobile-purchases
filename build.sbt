...
lazy val root = project
  ...
  .settings(
    ...
    riffRaffArtifactResources += file("tsc-target/soft-opt-in-acquisitions-dlq-processor.zip") -> s"mobile-purchases-soft-opt-in-acquisitions/soft-opt-in-acquisitions-dlq-processor.zip",
