...
lazy val root = project
  ...
  .settings(
    ...
    riffRaffArtifactResources += file("tsc-target/apple-link-user-subscription.zip") -> s"mobile-purchases-link-user-subscription/apple-link-user-subscription.zip",
    riffRaffArtifactResources += file("tsc-target/google-link-user-subscription.zip") -> s"mobile-purchases-link-user-subscription/google-link-user-subscription.zip",
